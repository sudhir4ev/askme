...
module.exports = {
  forbidden: [
    {
      name: "no-imports-from-package-x",
      severity: "error",
      comment: "Directly importing from package x is forbidden.",
      from: {}, // Optional: exclude specific files
      to: { path: "axios", reachable: true } // Regex for the package
    },
    // {
    //   name: 'no-circular',
    //   severity: 'warn',
...
// generated: dependency-cruiser@17.3.9 on 2026-03-26T16:09:14.958Z
